...
@property (nonatomic, strong, readwrite) NKCodecWindowController *codecVC;
...
- (void)didApplicationFinishLaunchingNotification:(NSNotification*)noti
{
    ...
    if (menuItem) {
        ...
        NSMenuItem *actionMenuItem = [[NSMenuItem alloc] initWithTitle:@"KWCodec" action:@selector(doShowMainWindow:) keyEquivalent:@""];
...
//    NSLog(@"[KWLM]%@-%@",notify.name,notify.object);
...
{
    self.codecVC = [[NKCodecWindowController alloc] initWithWindowNibName:@"NKCodecWindowController"];
    [self.codecVC showWindow:self.codecVC];
}
